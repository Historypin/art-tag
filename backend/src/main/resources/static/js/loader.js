/**
 * Thanks to http://www.jqueryscript.net/loading/Simple-jQuery-Loading-Spinner-Overlay-Plugin-Loader.html
 *
 * Removed comments and done some minor modifications.
 */
(function ($) {
    $.loader_ext = {
        defaults: {
    ...
    $.loader = {
        tmpl: '<div class="loading_wrp"><span class="loading_icon"></span><span class="text">${Title}</span> </div>',
