...
INSERT INTO "authorities"VALUES (nextval('hibernate_sequence'), 'admin', 'ROLE_USER');

INSERT INTO "system_user"(login, nick_name, password, games_played, games_won, total_score, enabled) VALUES ('api', 'api', '$2a$10$nkbmsSXt5bUv2EhOrRWkuORIpDvrEWOUq6jlq8n1DfaWu3SEq6Zoy', null, null, null, true);
INSERT INTO "authorities"VALUES (nextval('hibernate_sequence'), 'api', 'ROLE_API');
...
INSERT INTO "authorities"VALUES (nextval('hibernate_sequence'), 'user1', 'ROLE_USER');
...
INSERT INTO "authorities"VALUES (nextval('hibernate_sequence'), 'user2', 'ROLE_USER');
...
INSERT INTO "authorities"VALUES (nextval('hibernate_sequence'), 'user3', 'ROLE_USER');
